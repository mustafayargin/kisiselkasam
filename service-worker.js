const CACHE='kisisel-kasa-v2';
const APP_FILES=['./','./index.html','./style.css','./app.js','./firebase-auth.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png','./offline.html'];
